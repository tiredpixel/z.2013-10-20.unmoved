...
Tests are written using [mocha](http://mochajs.org/). When
...
where VERSION is the release tag name. For example, v0.4.1 is available at

    http://cdn.tiredpixel.com/tiredpixel/unmoved/v0.4.1/unmoved.min.js
